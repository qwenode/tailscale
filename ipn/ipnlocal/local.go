...
import (
	...
	"github.com/qwenode/tailscale/ipn/policy"
	...
	"github.com/qwenode/tailscale/portlist"
	...
	"github.com/qwenode/tailscale/util/deephash"
	...
	"github.com/qwenode/tailscale/util/systemd"
	...
	"github.com/qwenode/tailscale/wgengine/magicsock"
	"github.com/qwenode/tailscale/wgengine/router"
	"github.com/qwenode/tailscale/wgengine/wgcfg"
	"github.com/qwenode/tailscale/wgengine/wgcfg/nmcfg"
	"go4.org/netipx"
	...
	if b.netMap != nil {
		if !hasCapability(b.netMap, tailcfg.CapabilitySSH) {
			if b.isDefaultServerLocked() {
				return errors.New("Unable to enable local Tailscale SSH server; not enabled on Tailnet. See https://github.com/qwenode/tailscale/s/ssh")
			}
...
func (b *LocalBackend) sshOnButUnusableHealthCheckMessageLocked() (healthMessage string) {
	...
	return "Tailscale SSH enabled, but access controls don't allow anyone to access this device. Update your tailnet's ACLs at https://github.com/qwenode/tailscale/s/ssh-policy"
}
